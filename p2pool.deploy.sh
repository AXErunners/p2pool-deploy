...
FEE=0.5
DONATION=0.5
AXE_WALLET_URL=https://github.com/AXErunners/axe/releases/download/v1.2.1/axecore-1.2.1-x86_64-linux-gnu.tar.gz
AXE_WALLET_ZIP=axecore-1.2.1-x86_64-linux-gnu.tar.gz

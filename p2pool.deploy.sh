...
FEE=0.5
DONATION=0.5
AXE_WALLET_URL=https://github.com/AXErunners/axe/releases/download/v1.4.0/axecore-1.4.0-x86_64-linux-gnu.tar.gz
AXE_WALLET_ZIP=axecore-1.4.0-x86_64-linux-gnu.tar.gz
